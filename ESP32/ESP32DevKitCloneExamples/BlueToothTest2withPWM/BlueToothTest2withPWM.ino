  ...
  BP32.update();
   ...
   // if (myGamepad->y()) {
    ...
    if (Left>0){
      ...
      //digitalWrite(Bottom_Red, LOW);
      analogWrite(Top_Red, Left*1.5);
      analogWrite(Bottom_Red, 0);
    }
      else if (Left<0){
     // digitalWrite(Bottom_Red, HIGH);
      //digitalWrite(Top_Red, LOW);
      analogWrite(Bottom_Red, Left*(-1.5));
      analogWrite(Top_Red, 0);
      }
      else {
      analogWrite(Top_Red, 0);
      analogWrite(Bottom_Red, 0);
      ...
      //digitalWrite(Bottom_Green, LOW);
      analogWrite(Top_Green, Right*1.0);
      analogWrite(Bottom_Green, 0);
    }
      else if (Right<0){
      //digitalWrite(Bottom_Green, HIGH);
      //digitalWrite(Top_Green, LOW);
      analogWrite(Bottom_Green, Right*(-1.0));
      analogWrite(Top_Green, 0);
      }
      else {
        //digitalWrite(Top_Green, LOW);
        //digitalWrite(Bottom_Green, LOW);
